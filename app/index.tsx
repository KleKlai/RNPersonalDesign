  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={[styles.button, { backgroundColor: '#333' }]} onPress={() => signUpRef.current?.open()}>
            <Text style={[styles.buttonText, { color: '#fff'}]}>Sign up</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, { marginTop: 20}]} onPress={() => signIpRef.current?.open()}>
